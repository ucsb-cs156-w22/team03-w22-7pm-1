...
public class UCSBRequirementControllerTests extends ControllerTestCase {
        ...
        @WithMockUser(roles = { "USER" })
        @Test
        public void api_UCSBRequirements__user_logged_in__search_for_UCSBRequirement_that_does_not_exist()
                        throws Exception {
        ...
        public void api_UCSBRequirement__user_logged_in__put_UCSBRequirement() throws Exception {
                ...
                // Todo todo1 = Todo.builder().title("Todo 1").details("Todo
        ...
        @WithMockUser(roles = { "USER" })
        @Test
        public void api_UCSBRequirements__user_logged_in__cannot_put_UCSBRequirements_that_does_not_exist()
                        throws Exception {
                // arrange
