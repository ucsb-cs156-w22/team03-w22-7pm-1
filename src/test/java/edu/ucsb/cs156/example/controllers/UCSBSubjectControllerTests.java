...
public class UCSBSubjectControllerTests extends ControllerTestCase {
        ...
        public void api_ucsbsubjects_all__user_logged_in__returns_all_ucsbsubjects() throws Exception {
                ...
                UCSBSubject ucsbSubject1 = UCSBSubject.builder().id(0L).subjectCode("ucsbSubject1")
                                .subjectTranslation("Todo 1")
                                .deptCode("false")
                                .collegeCode("u1").relatedDeptCode("1L").inactive(true)
                                .build();
                UCSBSubject ucsbSubject2 = UCSBSubject.builder().id(1L).subjectCode("ucsbSubject2")
                                .subjectTranslation("Todo 2")
                                .deptCode("false")
                                .collegeCode("u2").relatedDeptCode("2L").inactive(true)
                                .build();
                UCSBSubject ucsbSubject3 = UCSBSubject.builder().id(2L).subjectCode("ucsbSubject3")
                                .subjectTranslation("Todo 3")
                                .deptCode("false")
